...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="images/icons/Gambar.png">
<!--===============================================================================================-->
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form  validate-form" method="post" action="proses_login.php" >
					<span>
						<center><img src="images/Gambar.png"  width="150"></center> <br>
					</span>
				...
				<div class="login100-more" style="background-image: url('images/los.jpeg');">
				</div>
			</div>
		</div>
	</div>
